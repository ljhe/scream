...
func (x *AccountRole) GetOpenId() string {
	if x != nil {
		return x.OpenId
	}
	return ""
...
func (x *CSCreateRoleReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CSCreateRoleReq) ProtoMessage() {}

func (x *CSCreateRoleReq) ProtoReflect() protoreflect.Message {
	mi := &file_user_proto_msgTypes[1]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CSCreateRoleReq.ProtoReflect.Descriptor instead.
...
func (x *SCCreateRoleAck) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SCCreateRoleAck) ProtoMessage() {}

func (x *SCCreateRoleAck) ProtoReflect() protoreflect.Message {
	mi := &file_user_proto_msgTypes[2]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SCCreateRoleAck.ProtoReflect.Descriptor instead.
...
const file_user_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"user.proto\x12\x04pbgo\"&\n" +
	"\vAccountRole\x12\x17\n" +
	"\aopen_id\x18\x01 \x01(\tR\x06openId\"\x11\n" +
	"\x0fCSCreateRoleReq\"\x11\n" +
	"\x0fSCCreateRoleAckB\bZ\x06.;pbgob\x06proto3"
...
var file_user_proto_goTypes = []any{
	(*AccountRole)(nil),     // 0: pbgo.AccountRole
	(*CSCreateRoleReq)(nil), // 1: pbgo.CSCreateRoleReq
	(*SCCreateRoleAck)(nil), // 2: pbgo.SCCreateRoleAck
}
