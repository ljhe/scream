...
const (
	MockService_Process_FullMethodName = "/mock.MockService/Process"
)
...
func (c *mockServiceClient) Process(ctx context.Context, in *MockRequest, opts ...grpc.CallOption) (*MockResponse, error) {
	...
	err := c.cc.Invoke(ctx, MockService_Process_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedMockServiceServer) Process(context.Context, *MockRequest) (*MockResponse, error) {
...
func _MockService_Process_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MockService_Process_FullMethodName,
	}
